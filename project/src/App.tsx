...
import { DashboardTab, BrowseTab, BookingsTab, FavoritesTab, MessagesTab, ProfileTab } from './pages/client/DashboardTabs';
import { DashboardTab as SPDashboardTab, BookingsTab as SPBookingsTab, PackagesTab as SPPackagesTab, FavoritesTab as SPFavoritesTab, MessagesTab as SPMessagesTab, ProfileTab as SPProfileTab } from './pages/service_provider_form/dashboard/DashboardTabs';
      ...
      <Routes>
        ...
        {user && (
          <>
            ...
            >
              <Route index element={<SPDashboardTab />} />
              <Route path="bookings" element={<SPBookingsTab />} />
              <Route path="packages" element={<SPPackagesTab />} />
              <Route path="favorites" element={<SPFavoritesTab />} />
              <Route path="messages" element={<SPMessagesTab />} />
              <Route path="profile" element={<SPProfileTab />} />
            </Route>
          </>
        )}
