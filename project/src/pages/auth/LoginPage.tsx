          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="w-full max-w-md mx-auto lg:mx-0">
              <button 
                ...
                className="mb-8 animate-fade-in inline-flex items-center px-5 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl shadow hover:shadow-lg hover:scale-105 transition-all duration-200 group"
              >
